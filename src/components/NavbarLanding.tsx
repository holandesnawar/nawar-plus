...
const MAIN = 'https://www.holandesnawar.com'
const NAV_LINKS = [
  { label: 'Inicio',         href: `${MAIN}/` },
  { label: 'Nuestra visión', href: `${MAIN}/nuestra-vision` },
  { label: 'Blog',           href: `${MAIN}/blog` },
  { label: 'Contacto',       href: `${MAIN}/contacto` },
]
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="h-[72px] flex items-center justify-between gap-8">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                href="https://www.holandesnawar.com/acceso"
                className="px-4 py-2 text-[15px] font-bold text-white/88 hover:text-white/50 transition-colors duration-200"
              >
                Acceso a alumnos
              </a>
